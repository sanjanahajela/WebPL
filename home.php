...
-->
<!DOCTYPE html>
<!-- saved from url=(0080)http://www.cs.virginia.edu/~up3f/cs4640/inclass/bootstrap/bootstrap-starter.html -->
...
<?php
    ...
    <div class= "jumbotron">
      <div class = "container">
        ...
        <p> 
          <a class= "btn btn-primary btn-lg" href= "search.php" role= "button"> Submit a Rating </a>   <!-- this button redirects to search page --> 
        </p>
      </div>
    </div>
     <div class= "container">
